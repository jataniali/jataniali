      ...
      <div className='grid lg:grid-cols-2 mt-4'>
        <div className='lg:w-1/2 bg-gray-200 lg:px-6 px-2 shadow-lg rounded-lg'>
          <div className='flex gap-4 mt-4 py-2'>
            <div className='text-3xl text-blue-400 border-[1px] bg-blue-200 rounded-full p-2 hover:bg-blue-400 hover:text-white'>
              <BiLocationPlus />
            </div>
            <div>
          ...
          <div className='flex gap-4 mt-8'>
            ...
            <div>
              <h2 className='text-base font-bold'>Call:</h2>
              <p className='text-gray-700'>+254757455196</p>
            </div>
          </div>
          <div className='mt-6'>
            <div className="w-full h-[600px] rounded-xl shadow-2xl overflow-hidden">
              <iframe
        ...
        <form className="space-y-4 mt-4" ref={form} onSubmit={sendEmail}>
          <div>
