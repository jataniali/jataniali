...
import edu1 from "../../assets/images/edu1.png"; // Import edu1
import edu2 from "../../assets/images/edu2.png"; // Import edu2
...
const All = () => {
  ...
  // Add edu1 and edu2 to the images array
  const images = [finance, todolist, weather, edu1, edu2];
